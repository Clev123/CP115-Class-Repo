...
coffee_name = "Coffee" # Assign Coffee name and values
coffee_price = 3.50
coffee_quantity = 2

muffin_name = "Muffin" # Assign Muffin name and values
muffin_price = 2.10
muffin_quantity = 3

water_name = "Water" # Assign Water name and values
water_price = 1.05
water_quantity = 4

coffee_total = coffee_price * coffee_quantity # Calculate total for Coffee, Muffin and Water
